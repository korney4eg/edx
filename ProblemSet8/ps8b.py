...
class SimpleVirus(object):
    ...
    def reproduce(self, popDensity):
        ...
        if reproduce < (float(self.getMaxBirthProb()) * (1 - popDensity)):
            #print 'I doubled'
...
class Patient(object):
    ...
    def __init__(self, viruses, maxPop):
        ...
        """
        #print 'Patient inits with',len(viruses)
    ...
    def update(self):
        ...
        density = float(len(self.viruses)) / self.getMaxPop()
        phase = 0
        for virus in self.viruses:
            #print newViruses
            newViruses.append(virus)
            #print phase, len(newViruses)
            phase += 1
            try:
        ...
        #print '================='
        #print 'There are',len(newViruses),'viruses'
...
def simulationWithoutDrug(numViruses, maxPop, maxBirthProb, clearProb,
    ...
    """
    leg = ()
    for turn in range( numTrials ):
        print turn
        viruses = []
        for i in range( int(numViruses) ):
        ...
        for i in range(300):
            ...
            pylab.plot ( times,numVirus,'.-',label='turn'+str(turn) )
            patient.update()
...
class TreatedPatient(Patient):
    ...
    def update(self):
        ...
        for virus in self.viruses:
            ...
            phase += 1
            try:
                newViruses.append(virus.reproduce(density,self.drugs))
            except NoChildException:
                #print 'failed to reproduce'
                pass
